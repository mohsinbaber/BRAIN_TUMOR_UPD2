...
saveBtn = Button(root, text="Save Data", height=2, width=20,background="#CBCBCB", command=save_data)
...
def on_enter(e):
    show_res_Btn['background'] = '#F0F0F0'

def on_leave(e):
    show_res_Btn['background'] = '#CBCBCB'
show_res_Btn = Button(root, text="Show Results", height=2, width=20,background="#CBCBCB", command=show_result)
show_res_Btn.place(x=400, y=575)
show_res_Btn.bind("<Enter>",on_enter)
show_res_Btn.bind("<Leave>",on_leave)
