...
nameText = Text(delete, width=55, height=0)
nameText.place(x=150,y=175)
...
deleteBtn = Button(delete, text="Delete Data", height=2,width=20,background="#CBCBCB", font=(None,10), command=del_data)
...
delete.protocol("WM_DELETE_WINDOW", disable_event)
